      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          },
          {
            name: '🎮 الألعاب',
            value: [
              '`مجازفة مبلغ` — 50/50 (كل 5 دقايق)',
              '`استثمر مبلغ [منخفض/متوسط/عالي]` — استثمار (كل 5 دقايق)',
              '`تداول مبلغ` — تداول بالسوق (كل 5 دقايق)',
              '`سرقة @شخص` — سرق شخص (كل 15 دقيقة)',
            ].join('\n')
          },
          {
            name: '🛡 الحماية',
